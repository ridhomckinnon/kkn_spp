                ...
                <ul class="space-y-2 pl-0">
                    <li class="relative px-3">
                        ...
                        <a href="" class="flex items-center no-underline hover:text-rose-500 p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white dark:hover:bg-gray-700">
                            <span class="w-5 h-5 flex items-center justify-center"><i class="fa fa-chart-pie"></i></span>
                            <span class="ml-3">Dashboard</span>
                        </a>
                    </li>
                    @if (auth()->user()->role == 'admin')
                    <li class="px-3">
                        <button type="button" class="flex items-center hover:text-rose-500 p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group dark:text-white dark:hover:bg-gray-700" aria-controls="setting" data-collapse-toggle="setting">
                        ...
                        <ul id="setting" class="hidden py-2 space-y-2">
                            <li>
                                <a href="/classes" class="flex items-center no-underline hover:text-rose-500 p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group dark:text-white dark:hover:bg-gray-700">Kelas</a>
                            </li>
                            <li>
                                <a href="/period" class="flex items-center no-underline hover:text-rose-500 p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group dark:text-white dark:hover:bg-gray-700">Periode</a>
                            </li>
                        </ul>
                    </li>
                    @endif
                    ...
                    <li class="px-3">
                        ...
                        <button type="button" class="flex items-center hover:text-rose-500 p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group dark:text-white dark:hover:bg-gray-700" aria-controls="transaction" data-collapse-toggle="transaction">
                        ...
                        <ul id="transaction" class="hidden py-2 space-y-2">
                            <li>
                                <a href="/mutation" class="flex items-center no-underline hover:text-rose-500 p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group dark:text-white dark:hover:bg-gray-700">Mutasi</a>
                            </li>
                            <li>
                                <a href="/transaction" class="flex items-center no-underline hover:text-rose-500 p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group dark:text-white dark:hover:bg-gray-700">Tunggakan</a>
                            </li>
                        </ul>
                    </li>
                    <li class="px-3">
