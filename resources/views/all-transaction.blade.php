                ...
                <table class="dataTable table-auto " style="width:100%">
                    <thead class="bg-rose-500 text-white">
                        <tr>
                            ...
                            <th class="font-bold p-4 text-left">Nama</th>
                            ...
                            <tr>
                                ...
                                <td class="text-left font-light p-3 border-b border-slate-100">
                                    <select name="" id="yearOpt" class="yearOpt border rounded-lg py-2 font-light">
                                        ...
                                        <option value="2022" class="py-2 font-light">2022</option>
                                        <option value="2023" class="py-2 font-light">2023</option>
                                        <option value="2024" class="py-2 font-light">2024</option>
                                        <option value="2025" class="py-2 font-light">2025</option>
                                        <option value="2026" class="py-2 font-light">2026</option>
                                    </select>
                                </td>


                                <td class="text-left border-b border-slate-100">
                                    <button class="no-underline btnDetail font-light" id="btnDetail"
