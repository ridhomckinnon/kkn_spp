            ...
            <div class="w-4/6 border rounded-xl px-4 pt-4">
                <form action="">
                    ...
                    <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                        ...
                        <input type="text" placeholder="Cari Kelas" class="pl-8 border focus:ring-rose-500 focus:border-rose-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-rose-500 dark:focus:border-rose-500 w-full rounded-xl h-12">
                    </div>
