        ...
        <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                <li class="mr-2" role="class">
                    <button class="inline-block p-4 rounded-t-lg border-b-2" id="active-class-tab" data-tabs-target="#active-class" type="button" role="tab" aria-controls="active-class" aria-selected="false">Kelas Aktif</button>
                </li>
                <li class="mr-2" role="class">
                    <button class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">Kelas Nonaktif</button>
                </li>

            </ul>
        </div>
        <div id="myTabContent">
            <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="active-class" role="tabpanel" aria-labelledby="active-class-tab">
            @if ($errors->any())
