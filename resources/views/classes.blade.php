                            ...
                            @foreach ($classes as $data)
                                <tr>
                                    ...
                                    <td class="text-left border-b border-slate-100">
                                        ...
                                        <a href="{{route('change.classes',['classes' => $data->id])}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800: no-underline"">Non aktifkan Kelas</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
